...
func TestMySQLXStore(t *testing.T) {
	...
	store, err := NewMySQLXStore("testuser:testpw@tcp(localhost:3306)/testdb?parseTime=true&loc=Local",
	...
	// Round 5 ----------------------------------------------------------------
	// MySQLXStore Delete session (not exposed by gorilla sessions interface).
